defmodule Rubik.F2L.Algorithms do
  ...
  def rotate_f2l_algo(algo, goal = [corner, _edge], face) do
    %Rubik.Algorithm{
      initial_state:
        AlgoHelpers.rotate_initial_state_f2l(
          algo.initial_state,
          goal,
          face
        ),
