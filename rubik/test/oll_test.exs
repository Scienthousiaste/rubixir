defmodule RubikOLLTest do
  ...
  defp u_or_x(true), do: ~c"u"
  defp u_or_x(false), do: ~c"x"
  ...
  test "OLL algos orient last layer and don't touch F2L" do
    ...
    oll_goal = [:DF, :DR, :DL, :DB, :DRF, :DRB, :DLF, :DLB, :LF, :LB, :RB, :RF]
    ...
    Enum.each(
      ...
      fn algo ->
        ...
        assert Helpers.goal_reached?(cube, oll_goal) and
                 Rubik.Solver.OLL.oll_completed?(cube, :D)
      end
    )
  end
end
