defmodule RubikGlobalTest do
  ...
  defp solve_a_cube() do
    ...
    %{cube: cube, moves: moves} =
      Rubik.scrambled_cube()
      |> Rubik.solve_cube()
  ...
  test "Every cube is solved" do
    ...
    IO.puts(
      "Solved #{@number_iterations} cubes, mean move count = #{all_moves / @number_iterations}, mean time = #{all_time / @number_iterations} milliseconds"
    )
  end
end
